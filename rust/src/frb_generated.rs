...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -917787372;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        17 => wire__crate__api__catalog__reread_track_tags_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__queue__save_queue_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__catalog__scan_library_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__settings__set_setting_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__catalog__track_path_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__catalog__track_paths_for_artist_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        23 => wire__crate__api__catalog__track_paths_for_library_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        24 => wire__crate__api__catalog__tracks_for_paths_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
