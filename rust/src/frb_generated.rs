...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 720707824;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__catalog__list_albums_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__catalog__list_artists_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__catalog__list_roots_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__catalog__list_tracks_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__queue__load_queue_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__tags__read_track_tags_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__catalog__record_play_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__catalog__remove_root_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__queue__save_queue_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        9 => wire__crate__api__simple__olivier_version_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
