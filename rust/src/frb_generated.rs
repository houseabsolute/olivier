...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -279540739;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        4 => wire__crate__api__enrich__enrich_album_impl(port, ptr, rust_vec_len, data_len),
        5 => wire__crate__api__enrich__enrich_artist_impl(port, ptr, rust_vec_len, data_len),
        6 => wire__crate__api__enrich__enrich_library_impl(port, ptr, rust_vec_len, data_len),
        7 => wire__crate__api__tags__extract_cover_impl(port, ptr, rust_vec_len, data_len),
        8 => wire__crate__api__settings__get_setting_impl(port, ptr, rust_vec_len, data_len),
        9 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        10 => wire__crate__api__catalog__list_albums_impl(port, ptr, rust_vec_len, data_len),
        11 => wire__crate__api__catalog__list_artists_impl(port, ptr, rust_vec_len, data_len),
        12 => wire__crate__api__catalog__list_roots_impl(port, ptr, rust_vec_len, data_len),
        13 => wire__crate__api__catalog__list_tracks_impl(port, ptr, rust_vec_len, data_len),
        14 => wire__crate__api__queue__load_queue_impl(port, ptr, rust_vec_len, data_len),
        16 => wire__crate__api__tags__read_track_tags_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__catalog__record_play_impl(port, ptr, rust_vec_len, data_len),
        18 => wire__crate__api__catalog__remove_root_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__catalog__reread_track_tags_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__queue__save_queue_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__catalog__scan_library_impl(port, ptr, rust_vec_len, data_len),
        22 => wire__crate__api__settings__set_setting_impl(port, ptr, rust_vec_len, data_len),
        23 => wire__crate__api__catalog__track_path_impl(port, ptr, rust_vec_len, data_len),
        24 => wire__crate__api__catalog__track_paths_for_artist_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        25 => wire__crate__api__catalog__track_paths_for_library_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        26 => wire__crate__api__catalog__tracks_for_paths_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        15 => wire__crate__api__simple__olivier_version_impl(ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
