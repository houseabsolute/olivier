...
void main() {
  testWidgets('opening Settings clears the active search query',
      (tester) async {
    ...
    await tester.pump(); // onPressed runs synchronously: clears query + pushes

    expect(container.read(searchQueryProvider), '');
    // The pushed SettingsPage may throw building against the test environment;
    // the synchronous clear above already happened, so tolerate any such
    // route-build exception after asserting the query was cleared.
