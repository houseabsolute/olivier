...
const _tracks = [
  QueueTrack(path: '/a.flac', title: 'One', album: 'X', addedAt: 0),
  QueueTrack(path: '/b.flac', title: 'Two', album: 'X', addedAt: 0),
...
void main() {
  testWidgets('expanded queue rows show 1-based order numbers', (tester) async {
