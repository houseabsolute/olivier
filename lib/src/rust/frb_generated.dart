...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateApiPlaylistsAddToPlaylist(
  ...
  Future<ArtistReading> crateApiCatalogArtistReading(
      {required String dbPath, required String mbid});

  Future<void> crateApiEnrichClearMbCache({required String dbPath});

  Future<String?> crateApiCoverCoverForPath(
      {required String dbPath,
      required String filePath,
      required String cacheDir});

  Future<String?> crateApiCoverCoverForRelease(
      {required String dbPath,
      required String releaseMbid,
      required String cacheDir});

  Future<PlatformInt64> crateApiPlaylistsCreatePlaylist(
      {required String dbPath, required String name});

  Future<void> crateApiPlaylistsDeletePlaylist(
      {required String dbPath, required PlatformInt64 id});

  Stream<EnrichProgress> crateApiEnrichEnrichAlbum(
      {required String dbPath, required String releaseMbid});

  Stream<EnrichProgress> crateApiEnrichEnrichArtist(
  ...
  Future<List<Playlist>> crateApiPlaylistsListPlaylists(
      {required String dbPath});
  ...
  Future<void> crateApiActivityLogActivity(
      {required String dbPath,
  ...
  Future<List<QueueTrack>> crateApiPlaylistsPlaylistTracks(
      {required String dbPath, required PlatformInt64 id});
  ...
  Future<void> crateApiCatalogRemoveTrack(
      {required String dbPath, required PlatformInt64 trackId});

  Future<void> crateApiPlaylistsRenamePlaylist(
      {required String dbPath,
      required PlatformInt64 id,
      required String name});

  Future<void> crateApiPlaylistsReorderPlaylists(
      {required String dbPath, required Int64List ids});

  Future<void> crateApiCatalogRereadAlbumTags(
      {required String dbPath, required String releaseMbid});

  Future<void> crateApiCatalogRereadTrackTags(
      {required String dbPath, required PlatformInt64 trackId});
  ...
  Future<void> crateApiPlaylistsSetPlaylistItems(
      {required String dbPath,
      required PlatformInt64 id,
      required List<String> paths});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateApiPlaylistsAddToPlaylist(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsAddToPlaylistConstMeta,
      argValues: [dbPath, id, paths],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsAddToPlaylistConstMeta =>
      const TaskConstMeta(
        debugName: "add_to_playlist",
        argNames: ["dbPath", "id", "paths"],
      );
  ...
  Future<ArtistReading> crateApiCatalogArtistReading(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(dbPath, serializer);
        sse_encode_String(mbid, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
            funcId: 4, port: port_);
      },
      codec: SseCodec(
        decodeSuccessData: sse_decode_artist_reading,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateApiCatalogArtistReadingConstMeta,
      argValues: [dbPath, mbid],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCatalogArtistReadingConstMeta =>
      const TaskConstMeta(
        debugName: "artist_reading",
        argNames: ["dbPath", "mbid"],
      );
  ...
  Future<String?> crateApiCoverCoverForPath(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCoverCoverForPathConstMeta,
      argValues: [dbPath, filePath, cacheDir],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCoverCoverForPathConstMeta => const TaskConstMeta(
        debugName: "cover_for_path",
        argNames: ["dbPath", "filePath", "cacheDir"],
      );
  ...
  Future<String?> crateApiCoverCoverForRelease(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCoverCoverForReleaseConstMeta,
      argValues: [dbPath, releaseMbid, cacheDir],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCoverCoverForReleaseConstMeta =>
      const TaskConstMeta(
        debugName: "cover_for_release",
        argNames: ["dbPath", "releaseMbid", "cacheDir"],
      );
  ...
  Future<PlatformInt64> crateApiPlaylistsCreatePlaylist(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsCreatePlaylistConstMeta,
      argValues: [dbPath, name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsCreatePlaylistConstMeta =>
      const TaskConstMeta(
        debugName: "create_playlist",
        argNames: ["dbPath", "name"],
      );
  ...
  Future<void> crateApiPlaylistsDeletePlaylist(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsDeletePlaylistConstMeta,
      argValues: [dbPath, id],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsDeletePlaylistConstMeta =>
      const TaskConstMeta(
  ...
  Stream<EnrichProgress> crateApiEnrichEnrichAlbum(
    ...
    unawaited(handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiEnrichEnrichAlbumConstMeta,
      argValues: [dbPath, releaseMbid, sink],
      apiImpl: this,
    )));
    return sink.stream;
  }

  TaskConstMeta get kCrateApiEnrichEnrichAlbumConstMeta => const TaskConstMeta(
        debugName: "enrich_album",
        argNames: ["dbPath", "releaseMbid", "sink"],
      );
  ...
  Stream<EnrichProgress> crateApiEnrichEnrichArtist(
    ...
    unawaited(handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_String(dbPath, serializer);
        sse_encode_String(artistMbid, serializer);
        sse_encode_StreamSink_enrich_progress_Sse(sink, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateApiEnrichEnrichArtistConstMeta,
      argValues: [dbPath, artistMbid, sink],
      apiImpl: this,
    )));
    return sink.stream;
  }

  TaskConstMeta get kCrateApiEnrichEnrichArtistConstMeta => const TaskConstMeta(
        debugName: "enrich_artist",
        argNames: ["dbPath", "artistMbid", "sink"],
      );
  ...
  Future<List<Playlist>> crateApiPlaylistsListPlaylists(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsListPlaylistsConstMeta,
      argValues: [dbPath],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsListPlaylistsConstMeta =>
      const TaskConstMeta(
        debugName: "list_playlists",
        argNames: ["dbPath"],
      );
  ...
  Future<void> crateApiActivityLogActivity(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiActivityLogActivityConstMeta,
      argValues: [dbPath, category, detail],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiActivityLogActivityConstMeta =>
      const TaskConstMeta(
        debugName: "log_activity",
        argNames: ["dbPath", "category", "detail"],
      );
  ...
  Future<List<QueueTrack>> crateApiPlaylistsPlaylistTracks(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsPlaylistTracksConstMeta,
      argValues: [dbPath, id],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsPlaylistTracksConstMeta =>
      const TaskConstMeta(
  ...
  Future<void> crateApiCatalogRemoveAlbum(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCatalogRemoveAlbumConstMeta,
      argValues: [dbPath, releaseMbid],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCatalogRemoveAlbumConstMeta => const TaskConstMeta(
  ...
  Future<void> crateApiCatalogRemoveTrack(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCatalogRemoveTrackConstMeta,
      argValues: [dbPath, trackId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCatalogRemoveTrackConstMeta => const TaskConstMeta(
        debugName: "remove_track",
  ...
  Future<void> crateApiPlaylistsRenamePlaylist(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsRenamePlaylistConstMeta,
      argValues: [dbPath, id, name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsRenamePlaylistConstMeta =>
      const TaskConstMeta(
        debugName: "rename_playlist",
        argNames: ["dbPath", "id", "name"],
      );
  ...
  Future<void> crateApiPlaylistsReorderPlaylists(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsReorderPlaylistsConstMeta,
      argValues: [dbPath, ids],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsReorderPlaylistsConstMeta =>
      const TaskConstMeta(
        debugName: "reorder_playlists",
        argNames: ["dbPath", "ids"],
      );
  ...
  Future<void> crateApiCatalogRereadAlbumTags(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCatalogRereadAlbumTagsConstMeta,
      argValues: [dbPath, releaseMbid],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCatalogRereadAlbumTagsConstMeta =>
      const TaskConstMeta(
        debugName: "reread_album_tags",
        argNames: ["dbPath", "releaseMbid"],
      );
  ...
  Future<void> crateApiCatalogRereadTrackTags(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCatalogRereadTrackTagsConstMeta,
      argValues: [dbPath, trackId],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCatalogRereadTrackTagsConstMeta =>
      const TaskConstMeta(
        debugName: "reread_track_tags",
        argNames: ["dbPath", "trackId"],
      );
  ...
  Future<void> crateApiCatalogSetArtistReadingOverride(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiCatalogSetArtistReadingOverrideConstMeta,
      argValues: [dbPath, mbid, reading, sort],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiCatalogSetArtistReadingOverrideConstMeta =>
      const TaskConstMeta(
        debugName: "set_artist_reading_override",
        argNames: ["dbPath", "mbid", "reading", "sort"],
      );
  ...
  Future<void> crateApiPlaylistsSetPlaylistItems(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateApiPlaylistsSetPlaylistItemsConstMeta,
      argValues: [dbPath, id, paths],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiPlaylistsSetPlaylistItemsConstMeta =>
      const TaskConstMeta(
        debugName: "set_playlist_items",
        argNames: ["dbPath", "id", "paths"],
      );
  ...
  ArtistReading dco_decode_artist_reading(dynamic raw) {
    ...
    return ArtistReading(
      ...
      nameOriginal: dco_decode_opt_String(arr[1]),
      mbTransliteration: dco_decode_opt_String(arr[2]),
      transliterationOverride: dco_decode_opt_String(arr[3]),
      mbSortName: dco_decode_String(arr[4]),
      sortNameOverride: dco_decode_opt_String(arr[5]),
    );
  }
  ...
  ArtistReading sse_decode_artist_reading(SseDeserializer deserializer) {
    ...
    var var_name = sse_decode_String(deserializer);
    var var_nameOriginal = sse_decode_opt_String(deserializer);
    var var_mbTransliteration = sse_decode_opt_String(deserializer);
    var var_transliterationOverride = sse_decode_opt_String(deserializer);
    var var_mbSortName = sse_decode_String(deserializer);
    var var_sortNameOverride = sse_decode_opt_String(deserializer);
    return ArtistReading(
        name: var_name,
        nameOriginal: var_nameOriginal,
        mbTransliteration: var_mbTransliteration,
        transliterationOverride: var_transliterationOverride,
        mbSortName: var_mbSortName,
        sortNameOverride: var_sortNameOverride);
  }
  ...
  Playlist sse_decode_playlist(SseDeserializer deserializer) {
    ...
    return Playlist(id: var_id, name: var_name, count: var_count);
  }
  ...
  void sse_encode_artist_reading(ArtistReading self, SseSerializer serializer) {
    ...
    sse_encode_String(self.name, serializer);
    sse_encode_opt_String(self.nameOriginal, serializer);
    sse_encode_opt_String(self.mbTransliteration, serializer);
    sse_encode_opt_String(self.transliterationOverride, serializer);
    sse_encode_String(self.mbSortName, serializer);
    sse_encode_opt_String(self.sortNameOverride, serializer);
  }
